            ...
            >
                ...
                <div className="bg-slate-800/90 backdrop-blur-xl rounded-2xl shadow-2xl border-2 border-purple-500/30 p-8 md:p-12">
                    ...
                    <button
                        ...
                        className="w-full py-4 px-6 bg-white/10 hover:bg-white/20 border-2 border-gray-600 hover:border-gray-500 text-white rounded-xl flex items-center justify-center gap-3 transition-all duration-300 text-lg font-medium"
                    >
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-base">
                                <span className="px-4 bg-slate-800 text-gray-400 font-medium">Or register with email</span>
                            </div>
                        </div>
                    </div>
